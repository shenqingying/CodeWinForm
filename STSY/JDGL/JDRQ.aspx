<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JDRQ.aspx.cs" Inherits="STSY.JDGL.JDRQ" MasterPageFile="~/sonluk.Master" %>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    &nbsp;
                                    <asp:Button ID="btnQBWC" runat="server" Text="全部完成" CssClass="sonluk-button" OnClick="btnQBWC_Click" />
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <asp:Label ID="lbISCONFIG" runat="server" Text="FALSE"></asp:Label>
                                    <asp:Label ID="lbISEND" runat="server" Text="FALSE"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </div>
                                                ...
                                                <asp:GridView ID="gdZDDJ" runat="server" AutoGenerateColumns="False" OnRowDataBound="gdZDDJ_RowDataBound" CellPadding="0">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="蛋糕">
                                                            <ItemTemplate>
                                                                <div style="float: right; text-align: right">
                                                                    <asp:TextBox ID="txtDG" runat="server" Text='<%# Bind("XMD") %>' Width="50" onkeydown="if(event.keyCode==13){event.keyCode=9;}">
                                                                    </asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="饼干">
                                                            <ItemTemplate>
                                                                <div style="float: right; text-align: right">
                                                                    <asp:TextBox ID="txtBG" runat="server" Text='<%# Bind("XMB") %>' Width="50" onkeydown="if(event.keyCode==13){event.keyCode=9;}">
                                                                    </asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="其他">
                                                            <ItemTemplate>
                                                                <div style="float: right; text-align: right">
                                                                    <asp:TextBox ID="txtQT" runat="server" Text='<%# Bind("XMQ") %>' Width="50" onkeydown="if(event.keyCode==13){event.keyCode=9;}">
                                                                    </asp:TextBox>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
