...
namespace STSY.FKSY
{
    public partial class SelectFKINFO2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //lbSTAFFID.Text = Request.QueryString["ID"];
                lbSTAFFID.Text = "59";
        ...
        private void BANDgvFKINFO()
        {
            ...
            DataTable dtFKINFO = serviceFINFO.Select_FKINFO(lbSTAFFID.Text, txtFKZH.Text, txtFKXM.Text, txtFKLFSJS.Text, txtFKLFSJE.Text, ddlFKZT.SelectedValue, GSDMRI, JRMWRI);
        ...
        {
            DataTable dt = serviceFINFO.Select_FKINFO_QX_GSDM(lbSTAFFID.Text);
        ...
        {
            DataTable dt = serviceFINFO.Select_FKINFO_QX_MW(lbSTAFFID.Text, ddlGSDM.SelectedValue);
