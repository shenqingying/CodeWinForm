<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RKSH.aspx.cs" Inherits="STSY.RKGL.RKSH"
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnDJTH" runat="server" Text="单据退回" CssClass="sonluk-button" OnClick="btnDJTH_Click" />
                                    <asp:Button ID="btnSHRK" runat="server" Text="审核入库" CssClass="sonluk-button" OnClick="btnSHRK_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <td>
                    <div>
                        <table>
                            <tr>
                                <td>
                                    <asp:LinkButton ID="LinkButton1" runat="server" BackColor="#ffffff" OnClick="LinkButton1_Click">入库单填写</asp:LinkButton>
                                    |
                                                                    ...
                                                                    <asp:TemplateField HeaderText="数量">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtSL" runat="server" Text='<%# Bind("SL") %>' Width="60" onkeydown="if(event.keyCode==13){event.keyCode=9;}"
                                                                                AutoPostBack="true" OnTextChanged="txtSL_TextChanged" CssClass="sonluk-text-right">
                                                                            </asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="单价">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtDJ" runat="server" Text='<%# Bind("DJ") %>' Width="60" onkeydown="if(event.keyCode==13){event.keyCode=9;}"
                                                                                AutoPostBack="true" OnTextChanged="txtDJ_TextChanged" CssClass="sonluk-text-right">
                                                                            </asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                ...
                                                                <asp:GridView ID="gdRKDLB" runat="server" AutoGenerateColumns="False" OnRowDataBound="gdRKDLB_RowDataBound" CellPadding="0">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="物料类别">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="WLLB" runat="server" Text='<%# Bind("WLLB") %>'>
                                                                                </asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
