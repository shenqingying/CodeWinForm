<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FKHDQR.aspx.cs" Inherits="STSY.YFGL.FKHDQR" MasterPageFile="~/sonluk.Master" EnableEventValidation="false" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnDJTH" runat="server" Text="单据退回" CssClass="sonluk-button" OnClick="btnDJTH_Click" />
                                    <asp:Button ID="btnHDQR" runat="server" Text="回单确认" CssClass="sonluk-button" OnClick="btnHDQR_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:Label ID="lbCaiGFPID" runat="server" Text="0"></asp:Label>
                                                    <asp:Label ID="lbisRePay" runat="server" Text="FALSE"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <asp:DropDownList ID="ddlGYS" runat="server" Enabled="false" Width="300">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtFPRQ" runat="server" Width="100" Enabled="false"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label19" runat="server" Text="发票金额" Width="70"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtFPJE" runat="server" Width="100" Enabled="false"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label20" runat="server" Text="付款金额" Width="70"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtFKJE" runat="server" Width="100" Enabled="false"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtFPHM" runat="server" Width="100" Enabled="false"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>发票说明
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label8" runat="server" Text="入库备注" Width="70"></asp:Label>
                                                        </td>
                                                        <td colspan="5">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label9" runat="server" Text="制单人" Width="70"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtRKZDR" runat="server" Width="100" Enabled="false"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label10" runat="server" Text="制单时间" Width="70"></asp:Label>
                                                        </td>
                                                        <td colspan="3">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:RadioButtonList ID="rbCX" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Value="0">已付款未回单</asp:ListItem>
                                                    <asp:ListItem Value="1">已回单</asp:ListItem>
                                ...
                                <td>
                                    <asp:GridView ID="gdFPMXLB" runat="server" AutoGenerateColumns="False" OnRowDataBound="gdFPMXLB_RowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="isRePay" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="isRePay" runat="server" Text='<%# Bind("isRePay") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
