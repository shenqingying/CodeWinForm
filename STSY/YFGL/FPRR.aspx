<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FPRR.aspx.cs" Inherits="STSY.YFGL.FPRR" EnableEventValidation="false"
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnADD" runat="server" Text="新增" CssClass="sonluk-button" OnClick="btnADD_Click" />
                                    <asp:Button ID="btnEDITOR" runat="server" Text="编辑" CssClass="sonluk-button" OnClick="btnEDITOR_Click" />
                                    <asp:Button ID="btnDELETE" runat="server" Text="删除" CssClass="sonluk-button" OnClick="btnDELETE_Click" />
                                    &nbsp;
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtFPJE" runat="server" OnTextChanged="txtFPJE_TextChanged" AutoPostBack="true" Width="100"></asp:TextBox>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label22" runat="server" Text="入库金额" Width="70"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtRKJE" runat="server" Width="100"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label23" runat="server" Text="加扣款" Width="70"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtJKK" runat="server" ForeColor="Red" Width="100"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>发票说明
                        ...
                        <table>
                            <tr>
                                <td style="vertical-align: top">
                                    <asp:Button ID="btnADDGLBD" runat="server" Text="添加关联表单" OnClick="btnADDGLBD_Click"
                                        Width="100" />
                                    <asp:Button ID="btnDELETEGLBD" runat="server" Text="删除关联表单" Width="100" OnClick="btnDELETEGLBD_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gdFPMXLB" runat="server" AutoGenerateColumns="False" OnRowDataBound="gdFPMXLB_RowDataBound"
                                        AllowPaging="True" Width="1500" PageSize="100">
                                        <Columns>
