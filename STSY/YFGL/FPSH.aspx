<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FPSH.aspx.cs" Inherits="STSY.YFGL.FPSH" MasterPageFile="~/sonluk.Master" EnableEventValidation="false" %>
        ...
        <table width="1000">
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnTJFK" runat="server" Text="提交付款" CssClass="sonluk-button" OnClick="btnTJFK_Click" />
                    <asp:Button ID="btnPLTJ" runat="server" Text="批量提交付款" CssClass="sonluk-button" OnClick="btnPLTJ_Click" />
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlGYS" runat="server">
                                </asp:DropDownList>
                            </td>
                            <td>入账日期
                            </td>
                            <td>
                                <asp:TextBox ID="txtRZRQ" runat="server" onClick="WdatePicker()"></asp:TextBox>
                            </td>
                            <td>入账类型
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlRZLX" runat="server">
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFPRQ" runat="server" onClick="WdatePicker()"></asp:TextBox>
                            </td>
                            <td>发票金额
                            </td>
                            <td>
                                <asp:TextBox ID="txtFPJE" runat="server" OnTextChanged="txtFPJE_TextChanged" AutoPostBack="true"></asp:TextBox>
                            </td>
                            <td>付款金额
                            </td>
                            <td>
                                <asp:TextBox ID="txtFKJE" runat="server"></asp:TextBox>
                            </td>
                            <td>发票号码
                            </td>
                            <td>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRKJE" runat="server"></asp:TextBox>
                            </td>
                            <td>加扣款
                            </td>
                            <td>
                                <asp:TextBox ID="txtJKK" runat="server" ForeColor="Red"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
