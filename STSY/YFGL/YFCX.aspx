<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YFCX.aspx.cs" Inherits="STSY.YFGL.YFCX" MasterPageFile="~/sonluk.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <asp:Label ID="lbRKDID" runat="server" Text="0" Visible="false"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    <div id="divFPLR" runat="server" align="left">
        <table>
            <tr>
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlGYS" runat="server" Enabled="false">
                                </asp:DropDownList>
                            </td>
                            <td>入账日期
                            </td>
                            <td>
                                <asp:TextBox ID="txtRZRQ" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>入账类型
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlRZLX" runat="server" Enabled="false">
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFPRQ" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>发票金额
                            </td>
                            <td>
                                <asp:TextBox ID="txtFPJE" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>付款金额
                            </td>
                            <td>
                                <asp:TextBox ID="txtFKJE" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>发票号码
                            </td>
                            <td>
                                <asp:TextBox ID="txtFPHM" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRKJE" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>加扣款
                            </td>
                            <td>
                                <asp:TextBox ID="txtJKK" runat="server" Enabled="false" ForeColor="Red"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtFPSM" runat="server" TextMode="MultiLine" Width="300" Enabled="false"></asp:TextBox>
                            </td>
                            <td>回单确认说明
                            </td>
                            <td colspan="3">
                                <asp:TextBox ID="txtHDQRSM" runat="server" TextMode="MultiLine" Width="300" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table>
            <tr>
                <td>
                    <asp:Button ID="btnADDGLBD" runat="server" Text="添加关联表单" OnClick="btnADDGLBD_Click" Width="100" Enabled="false" />
                    <asp:Button ID="btnDELETEGLBD" runat="server" Text="删除关联表单" Width="100" OnClick="btnDELETEGLBD_Click" Enabled="false" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRKCKBH" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="仓库名称"></asp:Label>
                            </td>
                            <td colspan="3">
                                <asp:TextBox ID="txtRKCKMC" runat="server" Width="300" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtRKGYSBH" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label4" runat="server" Text="供应商名称"></asp:Label>
                            </td>
                            <td colspan="3">
                                <asp:TextBox ID="txtRKGYSMC" runat="server" Width="300px" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtRKRKRQ" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label6" runat="server" Text="入库类型"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlRKRKLX" runat="server" Enabled="false">
                            ...
                            <td>
                                <asp:TextBox ID="txtRKRKDH" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <table>
                    ...
                    <table>
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtRKRKBZ" runat="server" TextMode="MultiLine" Height="50" Width="450"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRKZDR" runat="server" Width="200" Enabled="false"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label10" runat="server" Text="制单时间"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtRKZDSJ" runat="server" Width="200" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td>
                                <asp:RadioButtonList ID="rbCX" runat="server" RepeatDirection="Horizontal">
                                    ...
                                    <asp:ListItem Value="1">已提交未审核</asp:ListItem>
                                    <asp:ListItem Value="2">已审核</asp:ListItem>
                                    <asp:ListItem Value="3">已付款</asp:ListItem>
                                    <asp:ListItem Value="4">已回单</asp:ListItem>
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td>
                                <asp:Label ID="Label11" runat="server" Text="供应商编号"></asp:Label>
                            </td>
                            <td>
                            ...
                            <td>入账类型</td>
                            <td>
                                <asp:DropDownList ID="ddlRZLXLB" runat="server">
                                    <asp:ListItem Value="0">=请选择=</asp:ListItem>
                                    <asp:ListItem Value="1">主食</asp:ListItem>
                                    <asp:ListItem Value="2">副食</asp:ListItem>
                                    <asp:ListItem Value="3">其他</asp:ListItem>
                    ...
                    <asp:GridView ID="gdFPMXLB" runat="server" AutoGenerateColumns="False" OnRowDataBound="gdFPMXLB_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="供应商名称">
                                <ItemTemplate>
                                    <asp:Label ID="ClName" Width="100px" runat="server" Text='<%# Bind("ClName") %>'>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="发票日期">
                                <ItemTemplate>
                                    <asp:Label ID="FaPDate1" Width="80px" runat="server" Text='<%# Bind("FaPDate1") %>'>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="入账日期">
                                <ItemTemplate>
                                    <asp:Label ID="ACDate1" Width="80px" runat="server" Text='<%# Bind("ACDate1") %>'>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="类">
                                <ItemTemplate>
                                    <asp:Label ID="ACType" Width="30px" runat="server" Text='<%# Bind("ACType") %>'>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="审核时间">
                                <ItemTemplate>
                                    <asp:Label ID="AudiTime" Width="120px" runat="server" Text='<%# Bind("AudiTime") %>'>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="付款时间">
                                <ItemTemplate>
                                    <asp:Label ID="PayTime" Width="120px" runat="server" Text='<%# Bind("PayTime") %>'>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="填写时间">
                                <ItemTemplate>
                                    <asp:Label ID="fillTime" Width="120px" runat="server" Text='<%# Bind("fillTime") %>'>
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
