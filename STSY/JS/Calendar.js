...
document.writeln('</table></td></tr><!-- Author:F.R.Huang(meizz) http://www.meizz.com/ mail: meizz@ ... 02-10-8 -->');
...
//==================================================== WEB 页面显示部分 ======================================================
var outObject;
function setday(tt,obj) //主调函数,tt是传入这个打开日历事件的控件,obj是输出到的控件,如果没有obj参数则输出也是输出在tt控件上,最典型用法是onfocus="javascript:setday(this)"
{
