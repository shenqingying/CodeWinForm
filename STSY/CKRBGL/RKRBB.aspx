<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RKRBB.aspx.cs" Inherits="STSY.CKRBGL.RKRBB" MasterPageFile="~/sonluk.Master" %>
                    ...
                    <div>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label6" runat="server" Text="供应商编号" Width="70"></asp:Label>
                                </td>
                                <td>
