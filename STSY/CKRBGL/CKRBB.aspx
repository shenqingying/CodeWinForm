<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CKRBB.aspx.cs" Inherits="STSY.CKRBGL.CKRBB" MasterPageFile="~/sonluk.Master" %>
                ...
                <td>
                    <div>
                        <table>
                            <tr>
                                <td>
                                    <asp:GridView ID="GridView1" runat="server" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound" AllowPaging="True" PageSize="600" ShowFooter="true"></asp:GridView>
